<section class="brochures">
    <div class = "right-caret"><span class="glyphicon glyphicon-cloud-download"></span>
    </div>
    <div class="descarga-seccion">
        <div class="col-xs-12 descarga-title trans-delay">
            <p>NUESTROS CATÁLOGOS</p>
        </div>
